...
int_or_ptr64 make_Coq_Init_Datatypes_prod_pair(int_or_ptr64, int_or_ptr64, int_or_ptr64 *);
int_or_ptr64 alloc_make_Coq_Init_Datatypes_prod_pair(struct thread_info *, int_or_ptr64, int_or_ptr64);
...
unsigned int get_Coq_Init_Datatypes_prod_tag(int_or_ptr64);
...
struct Coq_Init_Datatypes_pair_args *get_Coq_Init_Datatypes_pair_args(int_or_ptr64);
...
void print_Coq_Init_Datatypes_prod(int_or_ptr64, void (*)(int_or_ptr64), void (*)(int_or_ptr64));
...
int_or_ptr64 make_Coq_Init_Datatypes_prod_pair(int_or_ptr64 $arg0, int_or_ptr64 $arg1, int_or_ptr64 *$argv)
{
...
int_or_ptr64 alloc_make_Coq_Init_Datatypes_prod_pair(struct thread_info *$tinfo, int_or_ptr64 $arg0, int_or_ptr64 $arg1)
{
  register int_or_ptr64 *$argv;
  $argv = (*$tinfo).alloc;
  *($argv + 0LL) = 2048LL;
...
unsigned int get_Coq_Init_Datatypes_prod_tag(int_or_ptr64 $v)
{
  register unsigned int $t;
  $t = get_boxed_ordinal($v);
  return $t;
...
struct Coq_Init_Datatypes_pair_args *get_Coq_Init_Datatypes_pair_args(int_or_ptr64 $v)
{
  return (struct Coq_Init_Datatypes_pair_args *) $v;
}
...
void print_Coq_Init_Datatypes_prod(int_or_ptr64 $v, void $print_param_A(int_or_ptr64), void $print_param_B(int_or_ptr64))
{
  register unsigned int $tag;
  register void *$args;
