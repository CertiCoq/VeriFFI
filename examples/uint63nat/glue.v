...
Definition f_get_unboxed_ordinal := {|
  ...
  fn_params := ((__v, (talignas 3%N (tptr (tptr tvoid)))) :: nil);
  fn_vars := nil;
  fn_temps := nil;
  fn_body :=
(Sreturn (Some (Ebinop Oshr
                 (Ecast (Etempvar __v (talignas 3%N (tptr (tptr tvoid))))
                   tulong) (Econst_long (Int64.repr 1) tlong) tulong)))
|}.
...
(Ssequence
  (Sset _t'1
    (Ederef
      (Ebinop Oadd
        (Ecast (Etempvar __v (talignas 3%N (tptr (tptr tvoid))))
          (tptr tulong)) (Econst_long (Int64.repr (-1)) tulong)
        (tptr tulong)) tulong))
...
Definition f_make_Coq_Init_Datatypes_nat_S := {|
  fn_return := (tptr (tptr tvoid));
  fn_callconv := cc_default;
  fn_params := ((__arg0, (talignas 3%N (tptr (tptr tvoid)))) ::
...
(Ssequence
  ...
  (Ssequence
    (Sassign
      ...
      (Etempvar __arg0 (talignas 3%N (tptr (tptr tvoid)))))
...
Definition f_alloc_make_prog_exp_eand := {|
  ...
  fn_callconv := cc_default;
  fn_params := ((__tinfo, (tptr (Tstruct _thread_info noattr))) ::
                (__arg0, (talignas 3%N (tptr (tptr tvoid)))) :: nil);
  fn_vars := nil;
...
Definition f_make_prog_exp_eif := {|
  ...
  fn_callconv := cc_default;
  fn_params := ((__arg0, (talignas 3%N (tptr (tptr tvoid)))) ::
                (__arg1, (talignas 3%N (tptr (tptr tvoid)))) ::
                (__arg2, (talignas 3%N (tptr (tptr tvoid)))) ::
                (__argv, (tptr tulong)) :: nil);
  fn_vars := nil;
  fn_temps := nil;
  fn_body :=
  ...
  (Ssequence
    ...
    (Ssequence
      (Sassign
        ...
        (Etempvar __arg1 (talignas 3%N (tptr (tptr tvoid)))))
      (Ssequence
        (Sassign
          (Ederef
            (Ebinop Oadd
              (Ecast (Etempvar __argv (tptr tulong)) (tptr tulong))
              (Econst_long (Int64.repr 3) tulong) (tptr tulong)) tulong)
          (Etempvar __arg2 (talignas 3%N (tptr (tptr tvoid)))))
        (Sreturn (Some (Ebinop Oadd (Etempvar __argv (tptr tulong))
                         (Econst_long (Int64.repr 1) tlong) (tptr tulong))))))))
|}.
...
Definition f_alloc_make_prog_exp_eif := {|
  ...
  fn_callconv := cc_default;
  fn_params := ((__tinfo, (tptr (Tstruct _thread_info noattr))) ::
                (__arg0, (talignas 3%N (tptr (tptr tvoid)))) ::
                (__arg1, (talignas 3%N (tptr (tptr tvoid)))) ::
                (__arg2, (talignas 3%N (tptr (tptr tvoid)))) :: nil);
  fn_vars := nil;
  fn_temps := ((__argv, (tptr tulong)) ::
               (_t'1, (tptr (talignas 3%N (tptr tvoid)))) :: nil);
  fn_body :=
  ...
  (Ssequence
    (Scall (Some _t'1)
      (Evar _is_ptr (Tfunction
                      (Tcons (talignas 3%N (tptr (tptr tvoid))) Tnil) tbool
                      cc_default))
      ((Etempvar __v (talignas 3%N (tptr (tptr tvoid)))) :: nil))
...
(Ssequence
  (Ssequence
    (Scall (Some _t'1)
      (Evar _get_unboxed_ordinal (Tfunction
                                   (Tcons (talignas 3%N (tptr (tptr tvoid)))
                                     Tnil) tuint cc_default))
      ((Etempvar __v (talignas 3%N (tptr (tptr tvoid)))) :: nil))
...
Definition f_get_Coq_Init_Datatypes_S_args := {|
  ...
  fn_temps := nil;
  fn_body :=
(Sreturn (Some (Ecast (Etempvar __v (talignas 3%N (tptr (tptr tvoid))))
...
Definition f_print_Coq_Init_Datatypes_nat := {|
  ...
  fn_temps := ((__tag, tuint) :: (__args, (tptr tvoid)) ::
               ...
               (_t'1, tuint) :: (_t'3, (tptr (tptr tvoid))) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Scall (Some _t'1)
                      ...
                      (Ederef
                        (Ebinop Oadd
                          (Ecast (Etempvar __args (tptr tvoid))
                            (talignas 3%N (tptr (tptr (tptr tvoid)))))
                          (Econst_int (Int.repr 0) tint)
                          (tptr (tptr (tptr tvoid)))) (tptr (tptr tvoid))))
                    (Scall None
                      (Evar _print_Coq_Init_Datatypes_nat (Tfunction
                                                            (Tcons
                                                              ...
                                                              Tnil) tvoid
                                                            cc_default))
                      ((Etempvar _t'3 (tptr (tptr tvoid))) :: nil)))
                  (Ssequence
                    (Scall None
...
Definition f_print_prog_exp := {|
  ...
  fn_temps := ((__tag, tuint) :: (__args, (tptr tvoid)) ::
               ...
               (_t'1, tuint) :: (_t'9, (tptr (tptr tvoid))) ::
                  ...
                  (Ssequence
                    (Ssequence
                      ...
                      (Scall None
                        ...
                        ((Etempvar _t'9 (tptr (tptr tvoid))) :: nil)))
                    (Ssequence
                      (Scall None
                        (Evar _printf (Tfunction (Tcons (tptr tschar) Tnil)
                                        tint cc_default))
                        ...
                        (Scall None
                          (Evar _print_prog_exp (Tfunction
                                                  (Tcons
                                                    (talignas 3%N (tptr (tptr tvoid)))
                                                    Tnil) tvoid cc_default))
                          ((Etempvar _t'8 (tptr (tptr tvoid))) :: nil)))
                      (Ssequence
                        (Scall None
                          (Evar _printf (Tfunction (Tcons (tptr tschar) Tnil)
                                          tint cc_default))
                ...
                (Ssequence
                  (Scall (Some _t'4)
                    (Evar _get_prog_eif_args (Tfunction
                                               ...
                                               (tptr (Tstruct _prog_eif_args noattr))
                                               cc_default))
                    ((Etempvar __v (talignas 3%N (tptr (tptr tvoid)))) ::
                     nil))
                  (Sset __args
                          ...
                          (Scall None
                            (Evar _print_prog_exp (Tfunction
                                                    (Tcons
                                                      (talignas 3%N (tptr (tptr tvoid)))
                                                      Tnil) tvoid cc_default))
                            ((Etempvar _t'7 (tptr (tptr tvoid))) :: nil)))
                        (Ssequence
                          (Scall None
                              ...
                              (Scall None
                                (Evar _print_prog_exp (Tfunction
                                                        (Tcons
                                                          ...
                                                          Tnil) tvoid
                                                        cc_default))
                                ((Etempvar _t'6 (tptr (tptr tvoid))) :: nil)))
                            (Ssequence
                              (Scall None
                                (Evar _printf (Tfunction
...
Definition f_print_prog_T := {|
  ...
  fn_temps := ((__tag, tuint) :: (__args, (tptr tvoid)) ::
               ...
               (_t'1, tuint) :: (_t'5, (tptr (tptr tvoid))) ::
  ...
  (Ssequence
    (Scall (Some _t'1)
      (Evar _get_prog_T_tag (Tfunction
                              (Tcons (talignas 3%N (tptr (tptr tvoid))) Tnil)
                              tuint cc_default))
      ((Etempvar __v (talignas 3%N (tptr (tptr tvoid)))) :: nil))
    (Sset __tag (Etempvar _t'1 tuint)))
  (Sswitch (Etempvar __tag tuint)
                      ...
                      (Scall None
                        (Evar _print_Coq_Init_Datatypes_bool (Tfunction
                                                               (Tcons
                                                                 ...
                                                                 Tnil) tvoid
                                                               cc_default))
                        ((Etempvar _t'4 (tptr (tptr tvoid))) :: nil)))
                    (Ssequence
                      (Scall None
                        (Evar _printf (Tfunction (Tcons (tptr tschar) Tnil)
                                        tint cc_default))
...
Definition f_halt := {|
  ...
  fn_callconv := cc_default;
  fn_params := ((__tinfo, (tptr (Tstruct _thread_info noattr))) ::
                (__env, (talignas 3%N (tptr (tptr tvoid)))) ::
                (__arg, (talignas 3%N (tptr (tptr tvoid)))) :: nil);
  fn_vars := nil;
  fn_temps := nil;
  fn_body :=
(Ssequence
      ...
      (Ebinop Oadd
        (Ecast
          (Efield
            ...
            (tarray (talignas 3%N (tptr tvoid)) 1024)) (tptr tulong))
        (Econst_long (Int64.repr 1) tulong) (tptr tulong)) tulong)
    (Etempvar __arg (talignas 3%N (tptr (tptr tvoid)))))
  (Sreturn None))
|}.

Definition v_halt_clo := {|
  gvar_info := (talignas 3%N (tarray (tptr (tptr tvoid)) 2));
...
Definition f_call := {|
  ...
  fn_callconv := cc_default;
  fn_params := ((__tinfo, (tptr (Tstruct _thread_info noattr))) ::
                (__clo, (talignas 3%N (tptr (tptr tvoid)))) ::
                (__arg, (talignas 3%N (tptr (tptr tvoid)))) :: nil);
  fn_vars := nil;
...
(Ssequence
  (Sset __f
    (Ederef
      (Ebinop Oadd
        (Ecast (Etempvar __clo (talignas 3%N (tptr (tptr tvoid))))
          (tptr tulong)) (Econst_long (Int64.repr 0) tulong) (tptr tulong))
      tulong))
  (Ssequence
    (Sset __envi
      (Ederef
        ...
        (Ecast (Etempvar __f (tptr tulong))
          (tptr (Tfunction
                  (Tcons (tptr (Tstruct _thread_info noattr))
                    (Tcons (talignas 3%N (tptr (tptr tvoid)))
                      (Tcons (talignas 3%N (tptr (tptr tvoid))) Tnil))) tvoid
                  cc_default)))
        ((Etempvar __tinfo (tptr (Tstruct _thread_info noattr))) ::
         (Etempvar __envi (tptr tulong)) ::
         (Etempvar __arg (talignas 3%N (tptr (tptr tvoid)))) :: nil))
      (Ssequence
        (Sset _t'1
          (Ederef
            (Ebinop Oadd
...
(Composite _thread_info Struct
 ...
 Composite _prog_eand_args Struct
   (Member_plain _prog_eand_arg_0 (talignas 3%N (tptr (tptr tvoid))) :: nil)
   noattr ::
 Composite _prog_eor_args Struct
   (Member_plain _prog_eor_arg_0 (talignas 3%N (tptr (tptr tvoid))) :: nil)
   noattr ::
 Composite _prog_eif_args Struct
   (Member_plain _prog_eif_arg_0 (talignas 3%N (tptr (tptr tvoid))) ::
    Member_plain _prog_eif_arg_1 (talignas 3%N (tptr (tptr tvoid))) ::
    Member_plain _prog_eif_arg_2 (talignas 3%N (tptr (tptr tvoid))) :: nil)
   noattr :: Composite _Coq_Init_Datatypes_tt_args Struct nil noattr ::
 Composite _prog_mkT_args Struct
   (Member_plain _prog_mkT_arg_0 (talignas 3%N (tptr (tptr tvoid))) ::
    Member_plain _prog_mkT_arg_1 (talignas 3%N (tptr (tptr tvoid))) ::
    Member_plain _prog_mkT_arg_2 (talignas 3%N (tptr (tptr tvoid))) :: nil)
   noattr :: nil).
 ...
 (_is_ptr,
   Gfun(External (EF_external "is_ptr"
                   (mksignature (AST.Tlong :: nil) AST.Tint8unsigned
                     cc_default))
     (Tcons (talignas 3%N (tptr (tptr tvoid))) Tnil) tbool cc_default)) ::
...
(_call :: _halt_clo :: _halt :: _print_prog_T ::
 ...
 _is_ptr :: _printf :: ___builtin_debug :: ___builtin_fmin ::
