...
(Ssequence
  (Sset _t'1
    (Ederef
      (Ebinop Oadd
        (Ecast (Etempvar __v (talignas 3%N (tptr tvoid)))
...
(Ssequence
  (Sassign
    (Ederef
      (Ebinop Oadd
        (Ecast (Etempvar __argv (tptr (talignas 3%N (tptr tvoid))))
          (tptr (talignas 3%N (tptr tvoid))))
        ...
        (Ssequence
          ...
          (Sassign
            ...
            (Ebinop Oadd (Etempvar _t'1 (tptr (talignas 3%N (tptr tvoid))))
              (Econst_long (Int64.repr 2) tulong)
              (tptr (talignas 3%N (tptr tvoid))))))
        (Sreturn (Some (Ebinop Oadd
                         (Etempvar __argv (tptr (talignas 3%N (tptr tvoid))))
                         (Econst_long (Int64.repr 1) tulong)
...
Definition f_call := {|
  ...
  fn_params := ((__tinfo, (tptr (Tstruct _thread_info noattr))) ::
                ...
                (__arg, (talignas 3%N (tptr tvoid))) :: nil);
  fn_vars := nil;
  fn_temps := ((__f, (tptr (talignas 3%N (tptr tvoid)))) ::
               (__envi, (tptr (talignas 3%N (tptr tvoid)))) ::
...
(Ssequence
  ...
  (Ssequence
    ...
    (Ssequence
      (Scall None
        (Ecast (Etempvar __f (tptr (talignas 3%N (tptr tvoid))))
          (tptr (Tfunction
        ...
        ((Etempvar __tinfo (tptr (Tstruct _thread_info noattr))) ::
         (Etempvar __envi (tptr (talignas 3%N (tptr tvoid)))) ::
